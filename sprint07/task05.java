        ...
        switch (order) {
            case ASC:
                Arrays.sort(addressBook, new Comparator<NameAddressPair>() {
                    @Override
                    public int compare(NameAddressPair address1, NameAddressPair address2) {
                        return address1.person.firstName.compareTo(address2.person.firstName) == 0
            ...
            case DESC:
                Arrays.sort(addressBook, new Comparator<NameAddressPair>() {
                    @Override
                    public int compare(NameAddressPair address1, NameAddressPair address2) {
                        return address2.person.firstName.compareTo(address1.person.firstName) == 0
